  ...
  let categories = data.categories;
    ...
    addToCartButtons.forEach((button, index) => {
      button.addEventListener("click", () => {
        let medicineSelect = document.getElementById(`select${index}`);
        ...
        // Update the cart table and the full amount
        updateCartTable();
...
// Function to update the full amount , total of the selected medicine and table rows
function updateCartTable() {
    ...
    cartItems.forEach(item => {
        ...
        let cell5 = newRow.insertCell(4); // New cell for Action buttons
        ...
        removeButton.addEventListener("click", () => {
            ...
            // Recalculate and update the full Amount
            updateCartTable();
        });
    ...
    // Update the full Amount in the table cell
...
document.getElementById("saveToFavourites").addEventListener("click", () => {
    // Save the cartItems array to localStorage using "fav" key
...
document.getElementById("applyFavourites").addEventListener("click", () => {
    // Retrieve the cartItems from localStorage using "fav" key
    let savedCart = localStorage.getItem("fav");
        ...
        // Update the cart table and the full Amount with saved items
        updateCartTable();
    } else {
